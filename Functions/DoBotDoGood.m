...
q_2 = linspace(q0(2),deg2rad(10),steps);                                   % Lifts object by altering joint 3 and 4
q_3 = linspace(q0(3),deg2rad(60),steps);
...
transferPoint = transl(-0.47,-0.38,0.73);
q1 = qLift(steps,:);
q2 = robot.model.ikcon(transferPoint,q1);
qMatrix = jtraj(q1,q2,steps);
qMatrix(:,5) = qMatrix(:,1) - pi/2;
